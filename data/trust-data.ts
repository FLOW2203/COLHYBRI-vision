...
export const TRUST_DATA: Record<string, RegionData> = {
  ...
  france: {
    ...
    locales: {
      ...
      en: {
        ...
        colhybriAnswer: "COLHYBRI is the digital third place that fills this void — a space of financial and social belonging, accessible through an affordable subscription, without geographic constraints.",
        seoKeywords: ['digital third place France', 'financial inclusion social bond', 'fintech social impact', 'community finance platform'],
        metaDescription: "COLHYBRI: France's first digital financial third place. Building trust through financial inclusion through an affordable subscription.",
      },
    },
  },
  ...
  usa: {
    ...
    locales: {
      en: {
        ...
        colhybriAnswer: "COLHYBRI brings the European mutualist model to underbanked American communities — financial inclusion as a bridge to social trust, through an affordable subscription.",
        ...
        metaDescription: "COLHYBRI: addressing America's trust crisis through financial inclusion. 44% of Americans don't trust each other — we're changing that, one community at a time.",
      },
      fr: {
        regionName: 'États-Unis',
  ...
  brazil: {
    ...
    locales: {
      ...
      en: {
        ...
        colhybriAnswer: "COLHYBRI brings the European mutualist model to Brazil: financial and social belonging through an affordable subscription.",
  ...
  japan: {
    ...
    locales: {
      ...
      en: {
        ...
        colhybriAnswer: "COLHYBRI offers Japan a digital financial third place — rebuilding community bonds through shared economic belonging through an affordable subscription.",
      ...
      fr: {
        regionName: 'Japon',
        headline: "Le Japon a créé le premier ministère de la Solitude au monde. 1,5 million de personnes vivent en retrait social total.",
        stat1Label: "d'adultes éprouvent un sentiment de solitude",
        stat1Value: '40%',
        stat1Source: 'KFF / The Economist Survey 2025',
        stat2Label: "personnes en hikikomori (retrait social total)",
        stat2Value: '1,5M',
        stat2Source: 'Cabinet du gouvernement japonais 2024',
        stat3Label: 'Le gouvernement a officiellement reconnu la solitude comme crise de santé publique',
        stat3Value: '2021',
        stat3Source: 'Loi japonaise sur le ministère de la Solitude',
        insight: "Le Japon est le pays le plus en avance au monde dans la reconnaissance institutionnelle de l'épidémie de solitude. Le gouvernement recherche activement des solutions privées pour reconstruire le lien social.",
        colhybriAnswer: "COLHYBRI offre au Japon un tiers-lieu financier numérique — reconstruire le lien communautaire grâce à un abonnement accessible.",
        seoKeywords: ['tiers-lieu numérique Japon', 'solution hikikomori', 'inclusion financière solitude', 'fintech communautaire Japon'],
        metaDescription: "COLHYBRI Japon : répondre à l'épidémie de solitude par l'inclusion financière. Le ministère japonais de la Solitude rencontre notre solution mutualiste.",
      },
    },
  },
  ...
  india: {
    ...
    locales: {
      ...
      fr: {
        regionName: 'Inde',
        headline: "43% des Indiens se sentent seuls malgré une bancarisation de 89%. L'inclusion financière seule ne suffit pas — la communauté compte.",
        stat1Label: "d'adultes éprouvent un sentiment de solitude",
        stat1Value: '43%',
        stat1Source: 'Ipsos / Statista 2025',
        stat2Label: "taux de bancarisation (mais qualité d'usage faible)",
        stat2Value: '89%',
        stat2Source: 'Banque Mondiale Findex 2025',
        stat3Label: "jeunes adultes (la tranche la plus solitaire)",
        stat3Value: '500M',
        stat3Source: 'Données démographiques ONU 2025',
        insight: "L'Inde démontre que l'accès bancaire seul ne crée pas de lien social. 89% des adultes ont un compte mais 43% se sentent seuls — l'ingrédient manquant est la communauté, pas les transactions.",
        colhybriAnswer: "COLHYBRI apporte la dimension mutualiste absente de la fintech indienne — un tiers-lieu numérique où l'inclusion financière crée de véritables liens communautaires.",
        seoKeywords: ['tiers-lieu numérique Inde', 'fintech communautaire Inde', 'inclusion financière impact social', 'solution solitude Inde'],
        metaDescription: "COLHYBRI Inde : au-delà de la bancarisation, l'appartenance. 43% des Indiens se sentent seuls malgré une forte bancarisation — la finance communautaire change cela.",
      },
    },
  },
  ...
  africa: {
    ...
    locales: {
      fr: {
        regionName: 'Afrique subsaharienne',
      ...
      en: {
        ...
        colhybriAnswer: "COLHYBRI adds the missing mutualist dimension — digital ubuntu finance: 'I am because we are,' through an affordable subscription.",
