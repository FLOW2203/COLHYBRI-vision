...
{s:"pour-les-collectivites",t:{fr:"COLHYBRI pour les collectivites : dashboard vitalite",en:"COLHYBRI for Cities: Vitality Dashboard",es:"COLHYBRI para colectividades: dashboard vitalidad"},d:{fr:"Déploiement clé en main sur 50 commerces. Score Maps, dashboard, rapport d'impact. Financé par les habitants à 3€/mois.",en:"Turnkey rollout for 50 businesses. Score Maps, dashboard, impact report.",es:"Despliegue llave en mano. Score Maps, dashboard, informe de impacto."},p:"/solution",r:["/tarifs-colhybri","/score-maps-audit"],x:"/action-coeur-de-ville"},
