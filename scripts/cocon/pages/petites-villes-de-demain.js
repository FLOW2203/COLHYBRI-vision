...
module.exports = {
  ...
  fr: {
    ...
    sections: [
      ...
      { h2: 'Comment COLHYBRI complete PVD ?', body: "COLHYBRI est l outil operationnel de mesure de la vitalite commerciale pour les chefs de projet PVD. Pilote gratuit 90 jours sur 50 commerces, dashboard municipal, rapport d impact pour le conseil municipal. Particulierement adapte aux petites communes qui n ont pas de manager de commerce dedie." },
    ],
    faq: [
      ...
      { q: 'Comment COLHYBRI aide une commune PVD ?', a: "Pilote gratuit 90 jours : audit Google de 50 commerces, dashboard de vitalite en temps reel, rapport d'impact pour le conseil municipal." },
    ],
    stats: [
  ...
  en: {
    ...
    sections: [
      ...
      { h2: 'How does COLHYBRI complement PVD?', body: 'COLHYBRI is the operational tool for measuring commercial vitality for PVD project leads. Free 90-day pilot on 50 shops, municipal dashboard, impact report. Especially suited to small towns without a dedicated commerce manager.' },
    ],
    faq: [
      ...
      { q: 'How does COLHYBRI help a PVD town?', a: 'Free 90-day pilot: Google audit of 50 shops, real-time vitality dashboard, city council impact report.' },
    ],
    stats: [
  ...
  es: {
    ...
    sections: [
      ...
      { h2: 'Como complementa COLHYBRI a PVD?', body: 'COLHYBRI es la herramienta operativa de medicion de la vitalidad comercial para los jefes de proyecto PVD. Piloto gratuito de 90 dias sobre 50 comercios, dashboard municipal, informe de impacto.' },
    ],
    faq: [
      ...
      { q: 'Como ayuda COLHYBRI a un municipio PVD?', a: 'Piloto gratuito de 90 dias: auditoria Google de 50 comercios, dashboard de vitalidad en tiempo real, informe de impacto.' },
    ],
    stats: [
