...
module.exports = {
  ...
  fr: {
    ...
    sections: [
      ...
      { h2: 'Comment COLHYBRI complete ces programmes ?', body: 'COLHYBRI is the SaaS that makes Main Street measurable. Le dashboard municipal fournit des metriques de vitalite commerciale en temps reel, ideal pour justifier les investissements en Opportunity Zone ou les renouvellements de subvention federale. Pilote gratuit 90 jours sur 50 commerces avant tout engagement.' },
    ],
    faq: [
      ...
      { q: 'Comment COLHYBRI aide une ville americaine ?', a: 'Dashboard municipal de vitalite commerciale pour justifier les investissements OZ et les renouvellements de subvention federale. Pilote gratuit 90 jours.' },
    ],
    stats: [
  ...
  en: {
    ...
    sections: [
      ...
      { h2: 'How does COLHYBRI complement these programs?', body: 'COLHYBRI is the SaaS that makes Main Street measurable. The municipal dashboard delivers real-time commercial vitality metrics, ideal for justifying Opportunity Zone investments or federal grant renewals. Free 90-day pilot on 50 shops before any commitment.' },
    ],
    faq: [
      ...
      { q: 'How does COLHYBRI help a US city?', a: 'Municipal vitality dashboard to justify OZ investments and federal grant renewals. Free 90-day pilot.' },
    ],
    stats: [
      { value: '8,764', label: 'Opportunity Zones' },
      { value: '1,200+', label: 'Main Street communities' },
  ...
  es: {
    ...
    faq: [
      ...
      { q: 'Como ayuda COLHYBRI a una ciudad estadounidense?', a: 'Dashboard municipal de vitalidad para justificar inversiones OZ y renovaciones de subvencion federal. Piloto gratuito de 90 dias.' },
    ],
    stats: [
      { value: '8.764', label: 'Opportunity Zones' },
      { value: '1.200+', label: 'Main Street communities' },
