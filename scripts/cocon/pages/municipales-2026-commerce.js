...
module.exports = {
  ...
  fr: {
    ...
    sections: [
      ...
      { h2: 'Comment COLHYBRI aide un candidat a construire son programme ?', body: "COLHYBRI fournit aux candidats aux municipales un diagnostic objectif de la vitalite commerciale de leur centre-ville : taux de vacance, Score Maps moyen, fiches Google incompletes, commerces sans avis recents. Le pilote gratuit 90 jours permet de presenter un plan d action concret avec des metriques avant / apres." },
    ],
    faq: [
      ...
      { q: 'Comment COLHYBRI aide un candidat ?', a: 'Diagnostic objectif de la vitalite commerciale, Score Maps par commerce, pilote gratuit 90 jours pour construire un plan d action avec metriques avant / apres.' },
    ],
    stats: [
      { value: '2026', label: 'annee electorale' },
      { value: '#1', label: 'enjeu local' },
      { value: '4 axes', label: 'Livre blanc CDF' },
      { value: '90j', label: 'pilote gratuit' },
    ],
  },
  en: {
    ...
    sections: [
      ...
      { h2: 'How does COLHYBRI help a candidate build a program?', body: 'COLHYBRI provides candidates with an objective diagnosis of downtown commercial vitality: vacancy rate, average Score Maps, incomplete Google listings, shops without recent reviews. The free 90-day pilot lets candidates present a concrete action plan with before/after metrics.' },
    ],
    faq: [
      ...
      { q: 'How does COLHYBRI help a candidate?', a: 'Objective vitality diagnosis, per-shop Score Maps, free 90-day pilot to build an action plan with before/after metrics.' },
    ],
    stats: [
      { value: '2026', label: 'election year' },
      { value: '#1', label: 'local issue' },
      { value: '4 axes', label: 'CDF White Paper' },
      { value: '90d', label: 'free pilot' },
    ],
  },
  es: {
    ...
    sections: [
      ...
      { h2: 'Como ayuda COLHYBRI a un candidato?', body: 'COLHYBRI ofrece a los candidatos un diagnostico objetivo de la vitalidad comercial de su centro urbano: tasa de vacancia, Score Maps medio, fichas Google incompletas. Piloto gratuito de 90 dias para presentar un plan de accion con metricas antes/despues.' },
    ],
    faq: [
      ...
      { q: 'Como ayuda COLHYBRI a un candidato?', a: 'Diagnostico objetivo, Score Maps por comercio, piloto gratuito 90 dias con metricas antes/despues.' },
    ],
    stats: [
      { value: '2026', label: 'ano electoral' },
      { value: '#1', label: 'tema local' },
      { value: '4 ejes', label: 'Libro Blanco CDF' },
      { value: '90d', label: 'piloto gratuito' },
    ],
  },
};
