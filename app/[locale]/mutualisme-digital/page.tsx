...
export default function CoconPage({ params: { locale } }: PageProps) {
  ...
  return (
    <SeoCoconPage
      ...
      relatedLinks={[
        { href: `/${l}/caffe-sospeso`, slug: "caffe-sospeso" },
        { href: `/${l}/economie-solidaire`, slug: "economie-solidaire" },
        { href: `/${l}/cooperative-quartier`, slug: "cooperative-quartier" }
      ]}
      crossLink={{ href: `/${l}/revitalisation-centres-villes`, slug: "revitalisation-centres-villes" }}
    />
  );
}
