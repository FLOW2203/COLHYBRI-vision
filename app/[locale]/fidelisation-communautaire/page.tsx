...
const SLUG = "fidelisation-communautaire";
...
export default function CoconPage({ params: { locale } }: PageProps) {
  ...
  return (
    <SeoCoconPage
      ...
      relatedLinks={[
        { href: `/${l}/commerce-equitable-local`, slug: "commerce-equitable-local" },
        { href: `/${l}/economie-solidaire`, slug: "economie-solidaire" },
        { href: `/${l}/pool-solidaire-quartier`, slug: "pool-solidaire-quartier" }
      ]}
      crossLink={{ href: `/${l}/pour-les-commercants`, slug: "pour-les-commercants" }}
    />
  );
}
