  ...
  return (
    <SeoCoconPage
      ...
      relatedLinks={[
        ...
        { href: `/${l}/rust-belt-revitalization`, slug: "rust-belt-revitalization" },
        { href: `/${l}/community-development`, slug: "community-development" }
      ]}
      crossLink={{ href: `/${l}/zrcv-zones-revitalisation`, slug: "zrcv-zones-revitalisation" }}
    />
  );
}
