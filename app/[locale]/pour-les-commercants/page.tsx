...
export async function generateMetadata({ params: { locale } }: PageProps) {
  const titles = {"fr":"COLHYBRI pour les commercants : 0% commission","en":"COLHYBRI for Merchants: 0% Commission","es":"COLHYBRI para comerciantes: 0% comision"};
  const descs = {"fr":"10 EUR/mois, 0% commission. Maps+ inclus. Nouveaux clients via pool solidaire.","en":"10 EUR/month, 0% commission. Maps+ included. New customers via solidarity pool.","es":"10 EUR/mes, 0% comision. Maps+ incluido."};
  return {
  ...
  return (
    <main className="min-h-screen bg-colhybri-cream">
      <section className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-sm border border-colhybri-teal/10 mb-12">
          ...
          <div className="flex flex-wrap gap-4 font-sans">
            ...
            <Link href="/maps-plus-outil" className="px-6 py-3 border-2 border-[#008080]/20 rounded-full hover:bg-[#008080]/5 transition-all">maps plus outil</Link>
            <Link href={`/${locale}/fidelisation-communautaire`} className="px-6 py-3 border-2 border-colhybri-gold/30 rounded-full hover:bg-colhybri-gold/10 transition-all">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "Article",
        "headline": "COLHYBRI for Merchants: 0% Commission",
