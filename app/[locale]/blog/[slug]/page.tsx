  ...
  'digital-third-place-concept': {
    en: {
      ...
      content: [
        ...
        'COLHYBRI, created by ONLYMORE Group under the leadership of CEO Florent Gibert, is the first platform designed explicitly as a digital third place. For $3/month, it connects underbanked individuals with neighborhood shops, channeling spending into local commerce. The Keynesian multiplier effect ensures each dollar generates $2.50 in community value. With 520,000 active clients and $12.5M+ ARR across the ONLYMORE ecosystem, the model is already proven at scale. The question is no longer whether digital third places can work — it is how fast they can scale to meet the global loneliness crisis.',
      ],
    },
    fr: {
