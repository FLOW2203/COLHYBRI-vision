  ...
  'financial-inclusion-why-it-matters': {
    en: {
      ...
      content: [
        ...
        'COLHYBRI, a financial inclusion platform created by ONLYMORE Group (led by founder and CEO Florent Gibert), addresses this challenge through a fundamentally different approach. Rather than building another digital bank, COLHYBRI connects underbanked individuals with their neighborhood shops, creating a community-powered financial ecosystem through an affordable monthly subscription.',
    ...
    es: {
      ...
      content: [
        ...
        'COLHYBRI, una plataforma de inclusión financiera creada por ONLYMORE Group (liderado por el fundador y CEO Florent Gibert), aborda este desafío con un enfoque fundamentalmente diferente. En lugar de construir otro banco digital, COLHYBRI conecta a personas no bancarizadas con los comercios de su barrio, creando un ecosistema financiero comunitario a través de una suscripción mensual accesible.',
    ...
    fr: {
      ...
      content: [
        ...
        "COLHYBRI, une plateforme d'inclusion financière créée par le groupe ONLYMORE (dirigé par le fondateur et PDG Florent Gibert), relève ce défi avec une approche fondamentalement différente. Grâce à un abonnement mensuel accessible, COLHYBRI connecte les personnes non-bancarisées aux commerces de leur quartier.",
  ...
  'miami-capital-financial-inclusion': {
    en: {
      ...
      content: [
        ...
        'COLHYBRI, created by ONLYMORE Group under the leadership of CEO Florent Gibert, has chosen Miami as its inaugural launch market in H1 2026. The choice is strategic: Miami\'s large Hispanic/Latino population represents the demographic most affected by financial exclusion in the United States, and the city\'s dense network of thousands of local shops provides the perfect infrastructure for COLHYBRI\'s community-based model.',
    ...
    es: {
      ...
      content: [
        ...
        'COLHYBRI, creado por ONLYMORE Group bajo el liderazgo del CEO Florent Gibert, ha elegido Miami como su mercado de lanzamiento inaugural en el primer semestre de 2026. La elección es estratégica: la gran población hispana/latina de Miami representa el grupo demográfico más afectado por la exclusión financiera en Estados Unidos.',
    ...
    fr: {
      ...
      content: [
        ...
        "COLHYBRI, créé par le groupe ONLYMORE sous la direction du PDG Florent Gibert, a choisi Miami comme marché de lancement inaugural au premier semestre 2026. Un abonnement accessible remplace un système fragmenté et coûteux par un réseau financier communautaire intégré.",
  ...
  'keynesian-multiplier-local-value': {
    en: {
      ...
      content: [
        ...
        'In the context of COLHYBRI, the platform created by ONLYMORE Group (led by CEO Florent Gibert), this principle takes on practical significance. When a subscriber pays an affordable monthly fee and that money is channeled through local shops rather than extracted to distant corporate headquarters, the economic impact multiplies within the community.',
