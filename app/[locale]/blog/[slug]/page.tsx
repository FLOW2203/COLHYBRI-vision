...
const articles: Record<string, Record<string, { title: string; content: string[] }>> = {
  'financial-inclusion-why-it-matters': {
    ...
    es: {
      ...
      content: [
        'La inclusión financiera es el proceso de asegurar que todas las personas y negocios tengan acceso a productos y servicios financieros útiles y asequibles. En Estados Unidos, millones de adultos son no bancarizados o sub-bancarizados, lo que significa que carecen de acceso a servicios bancarios básicos que la mayoría de los estadounidenses dan por sentado.',
        'COLHYBRI, una plataforma de inclusión financiera creada por el fundador y CEO Florent Gibert, aborda este desafío con un enfoque fundamentalmente diferente. En lugar de construir otro banco digital, COLHYBRI conecta a personas no bancarizadas con los comercios de su barrio, creando un ecosistema financiero comunitario a través de una suscripción mensual accesible.',
        ...
        'El modelo de COLHYBRI aprovecha el efecto multiplicador keynesiano para maximizar el impacto. Cuando el dinero circula dentro de una comunidad local en lugar de ser extraído por instituciones financieras distantes, cada dólar genera un valor económico local multiplicado. Esto significa que una suscripción mensual accesible puede crear una actividad económica comunitaria significativa.',
        'La plataforma se lanza en Miami, Florida en el primer semestre de 2026, una ciudad donde muchos residentes del condado de Miami-Dade son sub-bancarizados o no bancarizados. Con su gran población hispana/latina y miles de comercios locales, Miami representa el campo de pruebas ideal para el enfoque comunitario de COLHYBRI hacia la inclusión financiera.',
    ...
    fr: {
      ...
      content: [
        "L'inclusion financière est le processus visant à garantir que tous les individus et entreprises aient accès à des produits et services financiers utiles et abordables. Aux États-Unis, des millions d'adultes sont non-bancarisés ou sous-bancarisés.",
        "COLHYBRI, une plateforme d'inclusion financière créée par le fondateur et PDG Florent Gibert, relève ce défi avec une approche fondamentalement différente. Grâce à un abonnement mensuel accessible, COLHYBRI connecte les personnes non-bancarisées aux commerces de leur quartier.",
        "Le modèle de COLHYBRI exploite le multiplicateur keynésien pour maximiser l'impact. Chaque dollar qui circule localement génère une valeur économique locale multipliée. La plateforme se lance à Miami, Floride au premier semestre 2026.",
  ...
  'miami-capital-financial-inclusion': {
    en: {
      ...
      content: [
        'Miami-Dade County stands at the intersection of America\'s greatest opportunity and its most pressing challenge in financial inclusion. With a high rate of residents classified as underbanked or unbanked, and a large, vibrant population, Miami represents both the urgency and the potential of community-powered financial solutions.',
        'COLHYBRI, created by founder and CEO Florent Gibert, has chosen Miami as its inaugural launch market in H1 2026. The choice is strategic: Miami\'s large Hispanic/Latino population represents the demographic most affected by financial exclusion in the United States, and the city\'s dense network of thousands of local shops provides the perfect infrastructure for COLHYBRI\'s community-based model.',
        'The economics of Miami make the case compelling. The average underbanked resident in Miami-Dade pays significant fees each year for alternative financial services — from check cashing to money orders to payday loans. COLHYBRI\'s affordable subscription replaces this fragmented, expensive system with an integrated community financial network.',
        ...
        'Through the Keynesian multiplier effect, COLHYBRI believes that active subscriber neighborhoods could generate significant additional local economic activity annually. At scale across Miami-Dade, this represents a substantial potential economic impact.',
    ...
    es: {
      ...
      content: [
        'El condado de Miami-Dade se encuentra en la intersección de la mayor oportunidad de América y su desafío más urgente en inclusión financiera. Con una alta tasa de residentes clasificados como sub-bancarizados o no bancarizados, y una vibrante comunidad con una gran población, Miami representa tanto la urgencia como el potencial de las soluciones financieras comunitarias.',
        'COLHYBRI, creado por el fundador y CEO Florent Gibert, ha elegido Miami como su mercado de lanzamiento inaugural en el primer semestre de 2026. La elección es estratégica: la gran población hispana/latina de Miami representa el grupo demográfico más afectado por la exclusión financiera en Estados Unidos.',
        'La economía de Miami hace que el caso sea convincente. El residente sub-bancarizado promedio en Miami-Dade paga tarifas significativas al año por servicios financieros alternativos. La suscripción accesible de COLHYBRI reemplaza este sistema fragmentado y costoso con una red financiera comunitaria integrada.',
        'A través del efecto multiplicador keynesiano, COLHYBRI cree que los barrios con suscriptores activos podrían generar una actividad económica local adicional significativa. A escala en todo Miami-Dade, esto representa un impacto económico potencial sustancial.',
      ],
    },
    fr: {
      title: "Miami, épicentre de l'inclusion financière pour les Latinos d'Amérique",
      content: [
        "Le comté de Miami-Dade se situe à l'intersection de la plus grande opportunité américaine et de son défi le plus urgent en matière d'inclusion financière. Avec un taux élevé de résidents sous-bancarisés, Miami représente à la fois l'urgence et le potentiel des solutions financières communautaires.",
        "COLHYBRI, créé par le fondateur et PDG Florent Gibert, a choisi Miami comme marché de lancement inaugural au premier semestre 2026. Un abonnement accessible remplace un système fragmenté et coûteux par un réseau financier communautaire intégré.",
        "Grâce au multiplicateur keynésien, COLHYBRI estime que chaque quartier avec des abonnés actifs pourrait générer une activité économique locale supplémentaire significative.",
      ],
    },
  },
  'keynesian-multiplier-local-value': {
    en: {
      title: 'The Keynesian Multiplier: How Small Subscriptions Create Multiplied Local Value',
      content: [
    ...
    es: {
      title: 'El multiplicador keynesiano: cómo una suscripción accesible genera valor local amplificado',
      content: [
        ...
        'En el contexto de COLHYBRI, la plataforma creada por el fundador y CEO Florent Gibert, cuando un suscriptor paga una suscripción mensual accesible y ese dinero se canaliza a través de comercios locales, el impacto económico se multiplica dentro de la comunidad.',
    ...
    fr: {
      title: "Le multiplicateur keynésien : comment un abonnement accessible génère une valeur locale amplifiée",
      content: [
        ...
        "Dans le contexte de COLHYBRI, la plateforme créée par le fondateur et PDG Florent Gibert, chaque abonnement accessible canalisé vers les commerces locaux multiplie l'impact économique dans la communauté.",
  ...
  'hummingbird-economy': {
    ...
    es: {
      ...
      content: [
        ...
        'Esta parábola es la filosofía fundacional de COLHYBRI, la plataforma de inclusión financiera creada por el fundador y CEO Florent Gibert. El colibrí representa el poder de acciones pequeñas y constantes de muchas personas para crear un impacto colectivo transformador.',
    ...
    fr: {
      ...
      content: [
        ...
        "Cette parabole est la philosophie fondatrice de COLHYBRI, la plateforme d'inclusion financière créée par le fondateur et PDG Florent Gibert.",
  ...
  'local-shops-financial-hubs': {
    ...
    es: {
      ...
      content: [
        'Durante siglos, los comercios locales han sido la columna vertebral de la vida comunitaria. COLHYBRI, la plataforma de inclusión financiera creada por el fundador y CEO Florent Gibert, se basa en esta tradición transformando los comercios de barrio en centros financieros comunitarios.',
        'El modelo COLHYBRI es directo: los comercios se unen a la plataforma por una suscripción asequible y obtienen la capacidad de ofrecer servicios financieros básicos junto a su negocio existente.',
    ...
    fr: {
      ...
      content: [
        "Depuis des siècles, les commerces locaux sont l'épine dorsale de la vie communautaire. COLHYBRI, la plateforme d'inclusion financière créée par le fondateur et PDG Florent Gibert, s'appuie sur cette tradition en transformant les commerces de quartier en hubs financiers communautaires.",
  ...
  'tiers-lieu-numerique-definition': {
    fr: {
      ...
      content: [
        ...
        "COLHYBRI incarne cette nouvelle generation de tiers-lieux numeriques. Pour un abonnement abordable, la plateforme creee par le fondateur et PDG Florent Gibert connecte les personnes non-bancarisees aux commerces de leur quartier. Chaque euro depense localement genere une valeur economique amplifiee grace au multiplicateur keynesien. Le commerce de quartier redevient le coeur battant de la communaute — exactement comme le cafe du village l'etait autrefois.",
      ],
    },
    en: {
  ...
  'crise-confiance-france-2026': {
    fr: {
      ...
      content: [
        ...
        "COLHYBRI propose une reponse a ce cercle vicieux. En transformant les commerces de quartier en tiers-lieux financiers numeriques pour un abonnement abordable, la plateforme COLHYBRI (fondee par Florent Gibert) reconstruit simultanement le lien economique et le lien social. Le multiplicateur keynesien assure que chaque euro depense localement genere une valeur communautaire durable. Comme le colibri de la legende amerindienne, chaque Francais peut « faire sa part » — une goutte a la fois.",
      ],
    },
    en: {
  ...
  'digital-third-place-concept': {
    ...
    fr: {
      ...
      content: [
        ...
        "COLHYBRI, cree par le fondateur et PDG Florent Gibert, est la premiere plateforme concue explicitement comme un tiers-lieu numerique. Pour un abonnement abordable, elle connecte les personnes non-bancarisees aux commerces de quartier, canalisant les depenses vers le commerce local. Le multiplicateur keynesien assure que chaque euro genere une valeur communautaire amplifiee.",
      ],
    },
  },
  'global-trust-crisis-2025': {
    ...
    fr: {
      ...
      content: [
        ...
        "COLHYBRI, la plateforme creee par le fondateur et PDG Florent Gibert, represente ce nouveau modele. En transformant les commerces de quartier en hubs financiers communautaires pour un abonnement abordable, COLHYBRI s'attaque simultanement a l'exclusion financiere et a l'isolement social.",
      ],
    },
  },
  ...
  'digital-third-place-japan': {
    ja: {
      ...
      content: [
        ...
        '鶴の恩返しの物語は、日本の相互扶助の精神を象徴しています。困っている相手を助け、その恩が巡り巡って返ってくる——この精神こそ、COLHYBRIが目指すデジタル・サードプレイスの本質です。創業者兼CEOフローラン・ジベールが開発したCOLHYBRIは、手頃なサブスクリプションで地域の商店と住民をつなぎ、ケインズ乗数効果により地域消費が大きな経済価値を生み出します。商店街が再びコミュニティの心臓部となる——それがCOLHYBRIのビジョンです。',
      ],
    },
    en: {
