...
export async function generateMetadata({ params: { locale } }: PageProps) {
  ...
  return generatePageMetadata({
    ...
    semanticPrimary: 'Commerce Maroc 2030 Ryad Mezzour commercants proximite Casablanca',
    semanticSecondary: 'MRTB UM6P Fondation OCP Attijariwafa Al Barid Bank Coupe du Monde 2030',
    chunkType: 'page',
    audience: 'Moroccan local authorities, chambers of commerce, merchant associations',
  });
}
