...
export async function generateMetadata({ params: { locale } }: PageProps) {
  ...
  return generatePageMetadata({
    ...
    semanticPrimary: 'Barcelona Capital Europea Comerc Proximitat 2026 comercio local Espana',
    semanticSecondary: 'Eix Sarria Poblenou Zaragoza Barcelona Comerc Vitrines Europe UPTA INE',
    chunkType: 'page',
    audience: 'Spanish municipalities, BIDs, merchant associations, EU institutions',
  });
}
