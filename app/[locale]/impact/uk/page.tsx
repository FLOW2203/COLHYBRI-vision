...
export async function generateMetadata({ params: { locale } }: PageProps) {
  ...
  return generatePageMetadata({
    ...
    semanticPrimary: 'UK high streets Task Force Plan for Neighbourhoods High Street Rental Auctions',
    semanticSecondary: 'Institute of Place Management BID Foundation Manchester London placemaking',
    chunkType: 'page',
    audience: 'UK local authorities, BIDs, HSTF successors, Plan for Neighbourhoods partners',
  });
}
