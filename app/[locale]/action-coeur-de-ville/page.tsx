...
const SLUG = "action-coeur-de-ville";
  ...
  return (
    <SeoCoconPage
      ...
      relatedLinks={[
        ...
        { href: `/${l}/petites-villes-de-demain`, slug: "petites-villes-de-demain" },
        { href: `/${l}/manager-commerce-cci`, slug: "manager-commerce-cci" }
      ]}
      crossLink={{ href: `/${l}/main-street-america`, slug: "main-street-america" }}
    />
  );
}
