...
export async function generateMetadata({ params: { locale } }: PageProps) {
  const titles = {"fr":"COLHYBRI pour les particuliers : 3 EUR/mois","en":"COLHYBRI for Individuals: 3 EUR/Month","es":"COLHYBRI para particulares: 3 EUR/mes"};
  const descs = {"fr":"Pour 3 EUR/mois, contribuez au pool solidaire et recevez des services offerts.","en":"For 3 EUR/month, contribute to the solidarity pool and receive gifted services.","es":"Por 3 EUR/mes, contribuye al pool solidario."};
  return {
  ...
  return (
    <main className="min-h-screen bg-colhybri-cream">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "Article",
        "headline": "COLHYBRI for Individuals: 3 EUR/Month",
